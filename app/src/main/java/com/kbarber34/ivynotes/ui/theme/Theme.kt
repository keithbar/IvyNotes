package com.kbarber34.ivynotes.ui.theme
...
fun IvyNotesTheme(
  content: @Composable () -> Unit
    ...
    // Get the view model and UI state to obtain user preferences
    ...
    // Set flag for using dark theme based on saved user preference
    val useDarkTheme: Boolean = when (notesUiState.colorScheme) {
